...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('performance_meeting_actions', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('meeting_id')->index('performance_meeting_actions_meeting_id_foreign');
            $table->text('action_point');
            $table->unsignedInteger('added_by')->index('performance_meeting_actions_added_by_foreign');
