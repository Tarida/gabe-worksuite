...
return new class extends Migration
{
    ...
    {
        Schema::table('purchase_bill_histories', function (Blueprint $table) {
            $table->dropForeign('purchase_bill_histories_company_id_foreign');
            $table->dropForeign('purchase_bill_histories_purchase_bill_id_foreign');
            $table->dropForeign('purchase_bill_histories_purchase_order_id_foreign');
            $table->dropForeign('purchase_bill_histories_purchase_vendor_id_foreign');
            $table->dropForeign('purchase_bill_histories_user_id_foreign');
        });
    }
};
